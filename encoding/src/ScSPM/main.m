...
% directory setup
img_dir = 'E:\published\working\BoW\encoding\src\ScSPM\image';                  % directory for dataset images
data_dir = 'E:\published\working\BoW\encoding\src\ScSPM\data';                  % directory to save the sift features of the chosen dataset
dataSet = 'Caltech101';
